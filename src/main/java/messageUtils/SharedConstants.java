...
public class SharedConstants {
    ...
    public static final int SHARE_BOARD_REQUEST_CODE = 5;
    public static final int SHARE_BOARD_RESPONSE_CODE = 6;
    public static final int CREATE_POST_IT_REQUEST_CODE = 7;
    public static final int CREATE_POST_IT_RESPONSE_CODE = 8;
